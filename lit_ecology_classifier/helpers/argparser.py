...
def argparser():
    ...
    parser.add_argument("--datapath", nargs="*", default="/beegfs/desy/user/kaechben/eawag/training", help="Folder containing the tar training data")
    parser.add_argument("--train_outpath", default="/beegfs/desy/user/kaechben/eawag/train_out", help="Output path for training artifacts") #TODO change this for default scratch on cscs
